...
public class ATM {
	...
	public void deposit(double value) throws NegativeBalanceException {
		if (currentAccount != null)
	...
	public void transfer(int receiverId, double amount) throws NotEnoughBalanceException, NegativeBalanceException {
		if (currentAccount != null)
